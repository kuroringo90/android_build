...
include vendor/rising/config/BoardConfigRising.mk
...
ifneq ($(wildcard device/rising/sepolicy/common/sepolicy.mk),)
## We need to be sure the global selinux policies are included
## last, to avoid accidental resetting by device configs
$(eval include device/rising/sepolicy/common/sepolicy.mk)
endif
